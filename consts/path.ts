...
export const apiPath = {
    ...
    productos: {
        ...
        PATH_ListarProductRecomendado:
            "TPMaestraProductos/ListarMaestraRecomendados",
        ...
        PATH_GetProductsActualizados: (IdNegocio: string, IdProducto: string) =>
            `/TPMaestraProductos/ListarProductosActualizados/${IdNegocio}/${IdProducto}`,

        PATH_ListarProductosByNegocio: (prodId: string) =>
            `TPMaestraProductos/ListarMaestraProductosxNegocio/${prodId}`,

        PATH_ListarProductosInactives: (IdNegocio: string) =>
            `TPMaestraProductos/ListarProductosInactivos/${IdNegocio}`,
    },
    ...
    negocios: {
        ...
        PATH_ListarProductosByNegocios: (IdNegocio: string) =>
            `TPMaestraProductos/ListarMaestraProductosxNegocio/${IdNegocio}`,
    },
    pedidos: {
        PATH_ListarUNDMedida: "TPMaestraSelect/ListarUnidadMedida",
        PATH_SaveUNDMedida: "TPMaestraSelect/RegistrarUnidadMedida",
